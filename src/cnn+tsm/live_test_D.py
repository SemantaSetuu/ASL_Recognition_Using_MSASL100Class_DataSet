"""
live_test_D.py – real‑time webcam demo for Stage‑D TSM‑Attention model
----------------------------------------------------------------------
• Loads weights  .............. stage_d_tsm_attn.pth
• Loads class list ............ stage_d_classes.txt  (one label per line)
• MediaPipe‑Holistic to crop :  hands ⟶ face ⟶ centre‑crop fallback
• Slide‑window buffer of 64 frames (NUM_FRAMES)
...
CLASSES = Path("stage_d_classes.txt")             # written by Stage‑D training script
